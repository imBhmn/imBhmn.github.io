...
import {MenuIcon,ArrowRightIcon} from "nextra/icons"
import { useFSRoute } from 'nextra/hooks'
import { useConfig } from 'nextra-theme-docs';
import { useMenu } from './menu';
import { Item, PageItem ,MenuItem } from 'nextra/normalize-pages';
import { Menu,MenuButton,MenuItems, Transition} from '@headlessui/react';
import { MenuItem as MenuItemUI} from '@headlessui/react';
...
export type NavBarProps = {
  ...
  const classes = {
    ...
    active: clsx('nx-font-medium nx-subpixel-antialiased'),
    inactive: clsx(
  ...
  function NavbarMenu({
    ...
    return (
      <div className="nx-relative nx-inline-block">
        ...
        >
          <MenuItems className="nx-absolute nx-right-0 nx-z-20 nx-mt-1 nx-max-h-64 nx-min-w-full nx-overflow-auto nx-rounded-md nx-ring-1 nx-ring-black/5 nx-bg-white nx-py-1 nx-text-sm nx-shadow-lg dark:nx-ring-white/20 dark:nx-bg-neutral-800">
  ...
  export default function Header({ flatDirectories, items }: NavBarProps): ReactElement {
